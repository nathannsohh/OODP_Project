 ...
 * reservations in the restaurant, such as creating reservations and checking
 * for existing reservations made.
 * 
 * @author Nathan
 * @version 1.0
 * @since 2021-11-07
...
public class ReservationManager {
	...
	/**
	 * Creates a reservation for a customer and adds it into the arraylist of
	 * reservations made Reservations made have to be valid before adding to the
	 ...
	 * whether the reservation is made within 14 days in advance, and whether the
	 * reservation is made for a date and time in the past
	 * 
	 * @param datetime the date and time of the reservation
	...
	/**
	 * Checks for an existing reservation made, and displays the relevant
	 * reservation if it exists
	 * 
	 ...
	 * @param dateTime date and time of the reservation made
	 * @return the outcome of the removal, where true if the existing reservation
	 *         was removed and false if no such reservation was made
	 */
